...
static int __init init_dvbdev(void)
{
	...
	printk(KERN_ERR "WARNING: You are using an experimental version of the media stack.\n\tAs the driver is backported to an older kernel, it doesn't offer\n\tenough quality for its usage in production.\n\tUse it with care.\nLatest git patches (needed if you report a bug to linux-media@vger.kernel.org):\n\tf73696275e64d55c59947b42979b531cb026d718 [media] media-device: Simplify compat32 logic\n\t00303f9134c2db5d17bacda541c07d46517485d9 [media] media: i2c: ths7303: remove redundant assignment on bt\n\te8e20f1f02eb34b4d446101547159418346b65d4 [media] dvb-usb: hide unused functions\n");
